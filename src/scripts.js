...
// } 
 ...
 board.createEnemy({ item:'mini-demon', top: TILE_SIZE * 15, left: TILE_SIZE * 16});
 board.createEnemy({ item:'mini-demon', top: TILE_SIZE * 5, left: TILE_SIZE * 16});
 board.createEnemy({ item:'mini-demon', top: TILE_SIZE * 5, left: TILE_SIZE * 16});
 board.createEnemy({ item:'mini-demon', top: TILE_SIZE * 5, left: TILE_SIZE * 16});
